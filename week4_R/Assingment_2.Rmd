...
## call functions here
num <- sum(list_of_numbers)
num <- min(list_of_numbers)
num <- mean(list_of_numbers)
num <- mode(list_of_numbers)
num <- summary(list_of_numbers)
...
x = 0
my_list <- c(1, 10, x)
list_mean <- mean(my_list)  # Use a different variable name
while (list_mean < 10) {
  list_mean <- mean(my_list) 
  my_list[3] <- x
  x = x + 1
}
```
